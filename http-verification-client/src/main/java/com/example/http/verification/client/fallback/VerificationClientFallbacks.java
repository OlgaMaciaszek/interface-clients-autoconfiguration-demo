...
//	}
	...
	public Mono<String> testMono(String id) {
		return Mono.just("Fallback :" + id);
	}

	public Mono<String> testMonoThrowable(Throwable throwable, String id) {
		return Mono.just("Throwable: " + throwable + ", Fallback :" + id);
	}

	public Mono<Void> testVoid(Throwable throwable) {
		return Mono.empty();
	}

	public Flux<String> testFlux(String id) {
		return Flux.just("Fallback :" + id);
	}

	public Flux<String> testFluxThrowable(Throwable throwable, @PathVariable String id) {
		return Flux.just("Throwable: " + throwable + ", Fallback :" + id);
	}
}
